...
>
> "สวัสดีครับ!  ผมเป็นมือใหม่ที่เพิ่งหัดใช้ Arduino โปรเจกต์นี้คือผลลัพธ์จากการเรียนรู้เรื่องเซ็นเซอร์ การสื่อสารผ่าน Serial และการเขียนโปรแกรมร่วมกับ Python ผมพยายามปรับปรุงโค้ดให้ทำงานได้เสถียรที่สุดเท่าที่จะทำได้ สามารถนำไปใช้หรือแนะนำติชมได้เลยครับ!"
